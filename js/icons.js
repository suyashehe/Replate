/* RePlate – inline SVG icon set (stroke icons, 24x24 grid) */
(function () {
  const P = {
    ...
    handHeart: '<path d="M11 14h2a2 2 0 1 0 0-4h-3c-.6 0-1.1.2-1.4.6L3 16"/><path d="m7 20 1.6-1.4c.3-.4.8-.6 1.4-.6h4c1.1 0 2.1-.4 2.8-1.2l4.6-4.4a2 2 0 0 0-2.75-2.91l-4.2 3.9"/><path d="m2 15 6 6"/><path d="M19.5 8.5c.7-.7 1.5-1.6 1.5-2.7A2.73 2.73 0 0 0 16 4a2.78 2.78 0 0 0-5 1.8c0 1.2.8 2 1.5 2.8L16 12Z"/>',
    ...
    elder: '<circle cx="12" cy="5" r="2.5"/><path d="M12 8v6"/><path d="M9 11h6"/><path d="m9 21 3-7 3 7"/><path d="M18 12v9"/>',
  ...
  /* Brand mark: leaf over a plate */
  window.logoMark = function (size) {
    size = size || 34;
    return '<svg width="' + size + '" height="' + size + '" viewBox="0 0 40 40" aria-hidden="true">' +
      '<circle cx="20" cy="20" r="19" fill="var(--green-800)"/>' +
      '<circle cx="20" cy="22" r="11.5" fill="none" stroke="#fff" stroke-opacity=".35" stroke-width="1.6"/>' +
      '<path d="M13 27c0-9 6-15 16-16-1 10-6.5 16-14 16.2" fill="#8FD19E"/>' +
      '<path d="M13.2 27.4c3.2-4.6 6.6-8 11-10.6" stroke="#1f4d2e" stroke-width="1.6" fill="none" stroke-linecap="round"/>' +
      '</svg>';
  };
})();
